...
public class ReconnectionDaemon {
    ...
    private static final ReconnectionDaemon RECONNECTION_DAEMON = new ReconnectionDaemon();
    ...
    public ReconnectionDaemon() {
        this.reconnectionPeriods = "10".split(",");
        ...
        executor = new ThreadPoolExecutor(0, Integer.MAX_VALUE, KEEP_ALIVE_TIME, TimeUnit.SECONDS,
                new SynchronousQueue<>(), getThreadFactory("ReconnectionExecutorDaemon-"));
    }
